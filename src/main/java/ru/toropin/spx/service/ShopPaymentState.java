...
//Реализация для входного параметра "shop"
@Service
public final class ShopPaymentState implements PaymentState {
    //Ответы по операциям
    private final String NOT_ENOUGH_MONEY_ERR = "На счету клиента не хватает ДС. Баланс клиента: %.2f руб. Сумма платежа: %.2f руб.";
    private final String REPORT_OPERATION_RESULT = "Потрачено в Shop  %.2f руб. Баланс клиента: %.2f руб. Баланс бонусов: %.2f Б.";
    ...
    public String makePayment(double amountOfPayment) {
        ...
        //Проверка остатка ДС на РУБ счете клиента, для совершения платежа
